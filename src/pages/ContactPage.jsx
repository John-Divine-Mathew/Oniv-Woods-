...
export default function ContactPage() {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      ...
      .catch(() => {
        // Fallback for resilient client demo
        setSubmitted(true);
        setLoading(false);
      });
  };
  ...
  return (
    <div className="min-h-screen" style={{ background: "var(--oniv-ivory)", color: "var(--oniv-charcoal)" }}>
      ...
      {/* HERO SECTION */}
      <section
        className="relative w-full min-h-[65vh] flex items-center overflow-hidden pt-28 pb-16"
      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-5 space-y-8">
            ...
            <div className="space-y-4">
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-xs mt-1" style={{ color: "rgba(30,27,24,0.55)" }}>
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-sm" style={{ color: "var(--oniv-charcoal)" }}>
            ...
            {/* Scope List */}
            <div className="pt-2">
              <h4 className="text-xs font-bold uppercase tracking-wider mb-3" style={{ color: "var(--oniv-charcoal)" }}>
              ...
              <ul className="space-y-2 text-xs sm:text-sm" style={{ color: "rgba(30,27,24,0.75)" }}>
                {[
                  ...
                  <li key={idx} className="flex items-center gap-2.5">
                    <FiCheckCircle className="text-amber-600 shrink-0" size={15} />
                    <span>{item}</span>
                  </li>
                ))}
              </ul>
          ...
          <div className="lg:col-span-7">
            <div
              className="p-8 sm:p-10 rounded-2xl border shadow-xl bg-white"
              style={{ borderColor: "rgba(74,53,37,0.12)" }}
            >
              {!submitted ? (
                <form onSubmit={handleSubmit} className="space-y-5">
                  <div>
                    <h3 className="font-display text-2xl mb-1" style={{ color: "var(--oniv-charcoal)" }}>
                      Send an Inquiry
                    </h3>
                  ...
                  <div className="pt-2">
                    <button
                      type="submit"
                      disabled={loading}
                      className="w-full py-4 rounded-lg font-semibold text-sm transition-opacity hover:opacity-90 flex items-center justify-center gap-2 cursor-pointer"
                ...
                <div className="text-center py-16 space-y-4">
                  ...
                  <h3 className="font-display text-3xl font-semibold" style={{ color: "var(--oniv-charcoal)" }}>
                    Message Dispatched Successfully
                  </h3>
                  <p className="text-sm max-w-md mx-auto leading-relaxed" style={{ color: "rgba(30,27,24,0.7)" }}>
            ...
            {FAQS.map((faq, idx) => {
              ...
              return (
                ...
                >
                  ...
                  {isOpen && (
                    <div className="px-6 pb-5 pt-1 border-t text-sm leading-relaxed" style={{ borderColor: "rgba(74,53,37,0.06)", color: "rgba(30,27,24,0.7)" }}>
                      {faq.a}
                    </div>
                  )}
                </div>
