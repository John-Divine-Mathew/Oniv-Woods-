...
// Same real catalog/images used by the existing CourseList component.
const COURSES = [
  {
...
export default function CourseGrid() {
  ...
  return (
    <section id="courses" className="py-24" style={{ background: "var(--oniv-ivory)" }}>
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-12">
          ...
          <button
            ...
            className="self-start md:self-auto px-6 py-3 rounded-md font-medium border transition-colors hover:bg-black/5"
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-7">
          {COURSES.map((c, i) => (
            <motion.div
              ...
              className="group cursor-pointer rounded-xl overflow-hidden border bg-white transition-shadow hover:shadow-xl"
            ...
            >
              ...
              <div className="p-5">
                ...
                <h3 className="font-display text-xl mt-2" style={{ color: "var(--oniv-charcoal)" }}>
                  {c.title}
                </h3>
                <span
